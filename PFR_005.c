...
// contador pequeño con disipador vertical
#include <16F628A.h>
...
const int8 segment_map[10] = {
   0b0111111, //0b1110111, // // 0b0111111, // 0
   0b0100001, //0b0010001, // // 0b0001100, // 1
   0b1101110, // 0b1101101, // // 0b1101011, // 2
   0b1101011, // 0b0111101, // // 0b1101110, // 3
   0b1110001, // 0b0011011, // // 0b1011100, // 4
   0b1011011, // 0b0111110, // // 0b1110110, // 5
   0b1011111, // 0b1111110, // // 0b1110111, // 6
   0b0101001, // 0b0010101, // // 0b0101100, // 7
   0b1111111, // 0b1111111, // // 0b1111111, // 8
   0b1111001 // 0b0011111, // // 0b1111110  // 9
};
...
void display_update() {
   digit[0] = count % 10;          // Unidades
   digit[3] = (count / 10) % 10;   // Decenas
   digit[2] = (count / 100) % 10;  // Centenas
   digit[1] = (count / 1000) % 10; // Millar
}
